...
def read_single_subject(target_subject):
    ...
    test_data, test_tags = create_letter_test_data_color(gcd_res,
                                                         down_samples_param=down_sample_param, jitter=0)
...
if __name__ == "__main__":
    ...
    for subject_name in data_set_locations:
        train_data, train_tags, test_data, test_tags = read_single_subject(target_subject=subject_name)
